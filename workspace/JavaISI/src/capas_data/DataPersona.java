		...
		try {
			...
			if(rs!=null) {
				while(rs.next()) {
					...
					p.setId(rs.getString("tipo_doc")+rs.getString("nro_doc"));
	...
	public void add(Persona p) {
		...
		try {
            ...
            if(keyResultSet!=null && keyResultSet.next()){
            	...
            	p.setId(keyResultSet.getString(3)+keyResultSet.getString(4));
            } else {
            	p.setId(p.getDocumento().getTipo()+p.getDocumento().getNro());
            }
